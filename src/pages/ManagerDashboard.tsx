    ...
    <div className="min-h-screen bg-slate-50 flex flex-col pb-10">
      <header className="glass-header text-white p-5 sticky top-0 z-20 flex items-center gap-4">
        ...
        <nav className="flex items-center gap-3">
          <button onClick={() => setIsAddModalOpen(true)} className="flex items-center gap-1.5 bg-white text-blue-900 hover:bg-blue-50 px-4 py-2 rounded-xl font-bold transition-all shadow-lg active:scale-95">
          ...
          <button onClick={handleLogout} className="flex items-center justify-center w-10 h-10 rounded-xl bg-white/10 hover:bg-red-500/80 transition-colors border border-white/10" aria-label="Logout">
